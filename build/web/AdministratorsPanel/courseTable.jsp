...
<html>
    ...
    <body>
        ...
        <h1 class="m-3" style="padding: 50px;">View Details of Courses </h1>
        <div class="m-3">
            ...
            <table id="table" class="table table-dark table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td><%=sd.getCou_credit()%> </td>
                    <td><%=sd.getTotal_Marks()%> </td>
                    <td><%=sd.getCourse_code()%> </td>
                    <td><%=sd.getCourse_name()%> </td>
                    <td><%=sd.getIs_exempted()%> </td>
                    <td><%=sd.getIs_offered()%> </td>
                    <td><%=sd.getDepartment()%> </td>
                    <td><%=sd.getTerm()%> </td>
                    <td><%=sd.getYear()%> </td>
