...
<html>
    ...
    <body>
        <h1 class="shadow-lg mt-5  text-center pt-2" style="border-radius:20px; border: 1px solid skyblue;width: 250px;height: 70px;margin-left: 500px; ">Settings</h1>
        <div class="m-5">
            <hr>
            <label class="ml-2">Show Tooltip:</label>
            <label class="switch" style="margin-left: 700px;">
                <input type="checkbox" id="tooltip" >
                <span class="slider round"></span>
            </label>
            <hr>
            <label class="ml-2" style="display: inline;">Dark Mode:</label>
            <label class="switch" style="margin-left: 720px;">
                <input type="checkbox" id="dark_mode" onclick="myFunction()" >
                <span class="slider round"></span>
            </label>
