...
public class Exam_reg implements Comparable<Exam_reg>{
    private int regno;
    private String course_code,ex_reg_date,prog,ex_reg_term;
   ...
   public String getCourse_code() {
    ...
    @Override
    public int compareTo(Exam_reg o) {
        int compare =  Integer.compare(regno, o.regno);
