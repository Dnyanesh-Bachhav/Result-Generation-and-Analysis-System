...
public class Courses {
    ...
    public String toString() {
        return "Courses{" + "id=" + id + ", department=" + department + ", year=" + year + ", cou_credit=" + cou_credit + ", cou_th_max=" + cou_th_max + ", cou_pt_max=" + cou_pt_max + ", cou_tw_max=" + cou_tw_max + ", cou_or_max=" + cou_or_max + ", cou_pr_max=" + cou_pr_max + ", cou_th_min=" + cou_th_min + ", cou_pt_min=" + cou_pt_min + ", cou_tw_min=" + cou_tw_min + ", cou_or_min=" + cou_or_min + ", cou_pr_min=" + cou_pr_min + ", is_exempted=" + is_exempted + ", course_name=" + course_name + ", programme=" + programme + ", term=" + term + ", course_code=" + course_code + ", is_validated=" + is_validated + ", is_offered=" + is_offered + ", cou_pre_r1=" + cou_pre_r1 + ", cou_pre_r2=" + cou_pre_r2 + ", cou_pre_r3=" + cou_pre_r3 + ", cou_pre_r4=" + cou_pre_r4 + ", cou_remar=" + cou_remar + ", c_name=" + c_name + ", newcode=" + newcode + ", Course_Abbrevation=" + Course_Abbrevation + ", Theory=" + Theory + ", Tutorial=" + Tutorial + ", Practical=" + Practical + ", Total_Marks=" + Total_Marks + '}';
    }
