<%-- 
    Document   : OverallResultAnalysis
    Created on : 30 Apr, 2021, 8:09:54 PM
    Author     : tppat
--%>
...
<html>
    ...
    <body>  
          <%
            ...
            ArrayList<Integer> arrayOfCourseRegisterStudent = HodCon.getPendingStudentsByCourseCode(array1);
        %>
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: array2,
                    datasets: [{
                            label: 'No of Pending Students for Particular Subject',
                            data: arrayYAxis,
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
